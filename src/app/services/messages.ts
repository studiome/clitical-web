...
const EN = {
  ...
  downloadOnTheAppStore: 'Download CLiTICAL on the App Store',
  getItOnGooglePlay: 'Get CLiTICAL on Google Play',
  about: 'About',
  version: 'Version',
...
const JA: Messages = {
  ...
  settings: '設定',
  mobileApp: 'モバイルアプリ',
  downloadOnTheAppStore: 'App StoreからCLiTICALをダウンロード',
  getItOnGooglePlay: 'Google PlayでCLiTICALを手に入れよう',
  about: 'このアプリについて',
  version: 'バージョン',
